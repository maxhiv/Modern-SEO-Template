...
<body class="body1">
    ...
    <main>
        <!--=== HEOR AREA START === -->
        <div class="hero5" style="background-image: url(assets/img/bg/hero5-bg.jpg);">
            <div class="hero5-bg">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-5">
                            <div class="main-heading5">
                                <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span3.svg" alt="">SEOX STARTUP AGENCY </span>
                                <h1><span class="unic-text1">Empowering <img src="assets/img/shapes/hero5-title-shape.png" alt=""></span> <span class="unic-text2">Startups</span> to Scale Beyond Limits</h1>
                                <div class="buttons">
                                    <a class="theme-btn10" href="contact.php">Get Started Now <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                ...
                                <div class="reviews-area">
                                    <div class="review-image">
                                        <img src="assets/img/hero/hero5-reviews-img.png" alt="">
                                    </div>
                                    <div class="review-text">
                                        ...
                                        <p>Rated Best Over <b>15.7k</b> Reviews</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7 _relative">
                            <div class="hero5-images">
                                <div class="shape1 animate3">
                                    <img src="assets/img/shapes/hero5-shape1.png" alt="">
                                </div>
                                <div class="shape2 animate1">
                                    <img src="assets/img/shapes/hero5-shape2.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="heading5 md:mt-30 sm:mt-30">
                            <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span5.svg" alt="">ABOUT US </span>
                            ...
                            <div class="button mt-30" data-aos="fade-left" data-aos-delay="300" data-aos-duration="1000">
                                <a class="theme-btn10" href="about.php">Learn More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="service5 sp sec-bg4">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="heading5">
                            <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span5.svg" alt="">OUR SERVICES </span>
                    ...
                    <div class="col-lg-4">
                        <div class="button text-end sm:text-start md:text-start md:mt-30 sm:mt-30" data-aos="fade-left" data-aos-duration="1000" data-aos="fade-left" data-aos-delay="200" data-duration="900">
                            <a class="theme-btn10" href="service.php">View All Services <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="row mt-30">
        ...
        <div class="work5 sp">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="heading5">
                            <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span5.svg" alt="">HOW WE WORK </span>
                    ...
                    <div class="col-lg-6">
                        <div class="work5-images ml-30 md:ml-0 sm:ml-0 md:mt-30 sm:mt-30">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image image-anime reveal">
                                        <img src="assets/img/work/work5-image1.png" alt="">
                                    </div>
                                    <div class="image mt-30 image-anime reveal">
                                        <img src="assets/img/work/work5-image2.png" alt="">
                                    </div>
                                </div>

                                <div class="col-lg-6">
                                    <div class="image mt-30 image-anime reveal">
                                        <img class="w-full" src="assets/img/work/work5-image3.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="choose5 sp sec-bg4">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="heading5">
                            <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span5.svg" alt="">WHY CHOOSE US </span>
                    ...
                    <div class="col-lg-6">
                        <div class="button text-end sm:text-start md:text-start md:mt-30 sm:mt-30" data-aos="fade-left" data-aos-duration="1000">
                            <a class="theme-btn10" href="contact.php">Contact Us Now <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-16">
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200" data-aos-duration="900">
                        <div class="choose5-box mt-30">
                            <div class="image">
                                <img src="assets/img/others/choose5-image1.png" alt="">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300" data-aos-duration="900">
                        <div class="choose5-box mt-30">
                            <div class="image">
                                <img src="assets/img/others/choose5-image2.png" alt="">
                            </div>
                            <div class="content heading5 mt-16">
                                <h4><a href="#">Holistic Growth Solutions</a></h4>
                                <p class="mt-10">SEOX offers a comprehensive suite of services, including branding, marketing, and technology solutions, to support every stage startup’s growth journey.</p>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="400" data-aos-duration="900">
                        <div class="choose5-box mt-30">
                            <div class="image">
                                <img src="assets/img/others/choose5-image3.png" alt="">
                            </div>
                            <div class="content heading5 mt-16">
                                <h4><a href="#">Holistic Growth Solutions</a></h4>
                                <p class="mt-10">SEOX offers a comprehensive suite of services, including branding, marketing, and technology solutions, to support every stage startup’s growth journey.</p>
        ...
        <div class="team5 sp">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="heading5">
                            <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span5.svg" alt="">OUR TEAM </span>
                            <h2 class="text-anime-style-3">Meet Our Creative Crew</h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="button text-end sm:text-start md:text-start md:mt-30 sm:mt-30" data-aos="fade-left" data-aos-duration="1000">
                            <a class="theme-btn10" href="team.php">Our Team Member <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="row mt-30">
        ...
        <div class="tes6 sp sec-bg4">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="heading5">
                            <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span5.svg" alt="">OUR TESTIMONIALS </span>
                            <h2 class="text-anime-style-3">Real Stories, Real Success </h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="button text-end sm:text-start md:text-start md:mt-30 sm:mt-30" data-aos="fade-left" data-aos-duration="1000">
                            <a class="theme-btn10" href="blog.php">View All Review <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="tes5-all-area" data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
                                    ...
                                    <div class="tes5-slider">
                                        <div class="tes5-single-slider">
                                            <div class="brand-logo">
                                                <img src="assets/img/others/microsoft.png" alt="">
                                            </div>
                        ...
                        <div class="circle-shape">
                            <img src="assets/img/shapes/tes6-sec-shape.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="blog2 sp">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="heading5">
                            <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span5.svg" alt="">OUR BLOG </span>
                            <h2 class="text-anime-style-3">Insights & Trends in Social Media</h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="button text-end sm:text-start md:text-start md:mt-30 sm:mt-30" data-aos="fade-left" data-aos-duration="1000">
                            <a class="theme-btn10" href="blog.php">See All Blogs <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                        </div>
                    </div>
                </div>
                <div class="row mt-30">
    ...
    <footer class="vl-footer-area1 bg-cover" style="background-image: url(assets/img/bg/footer5-bg.jpg);">
        <!-- cta area start -->

               ...
               <div class="col-lg-12">
                  <article>
                     <div class="details-content">
                        <div class="image">
                           <img class="w-full" src="assets/img/service/service-details5-image.png" alt="">
                        </div>
                     </div>
                  </article>
               </div>
                     ...
                     <div class="_sidebar-widget _list mt-40">
                        ...
                        <div class="sidebar-list">
                           <ul>
                              ...
                              <li><a href="service-details5.php" class="active">Travel Guide Expertise <span><i class="fa-solid fa-angle-right"></i></span></a></li>

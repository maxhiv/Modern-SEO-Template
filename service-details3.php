               ...
               <div class="col-lg-12">
                  <article>
                     <div class="details-content">
                        <div class="image">
                           <img class="w-full" src="assets/img/service/service-details3-image.png" alt="">
                        </div>
                     </div>
                  </article>
               </div>
                  ...
                  <div class="sidebar-area mt-50">
                     ...
                     <div class="_sidebar-widget _list mt-40">
                        ...
                        <div class="sidebar-list">
                           <ul>
                              <li><a href="service-details1.php">SEO Marketing <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                              <li><a href="service-details2.php">Social Media Strategy <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                              <li><a href="service-details3.php" class="active">Content Marketing <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                              <li><a href="service-details4.php">Pay-Per-Click Advertising <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                              <li><a href="service-details5.php">Travel Guide Expertise <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                              <li><a href="service-details6.php">HR Staffing Agency <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                              <li><a href="service-details7.php">Insurance Policy <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                              <li><a href="service-details8.php">Real Estate <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                              <li><a href="service-details9.php">Startup Agency <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                           </ul>
                        </div>
                     </div>
                     ...
                     <div class="_sidebar-widget _buttons mt-40">
                        ...
                        <div class="buttons mt-16">
                           <a href="mailto:Infoseoxagency@gmail.com" class="sidebar-btn1"><img src="assets/img/icons/sidebar-email.png" alt=""> Infoseoxagency@gmail.com</a>
                           <a href="tel:123-456-7890" class="sidebar-btn2"><img src="assets/img/icons/sidebar-phone.png" alt=""> 123-456-7890</a>
                        </div>
                     </div>
                     ...
                     <article>
                        <div class="details-content">
                           <div class="heading2 mt-24">
                              ...
                              <p class=" mt-16">We craft compelling content strategies designed to attract, engage, convert your audience. Our data-driven approach ensures that every piece of content serves a purpose—whether it's boosting brand awareness, increasing website traffic, or generating leads. From blog posts and website copy to videos and social media content, we create high-quality, SEO-optimized content that resonates with your target audience and strengthens your brand authority.</p>
                           </div>
                           ...
                           <div class="row pt-10">
                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    <h4><a href="#">Research & Strategy Development</a></h4>
                                    <p class="mt-12">We analyze your industry, competitors, and audience insights to craft a content strategy that aligns with your goals.</p>
                                 </div>
                              </div>

                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    <h4><a href="#">Content Creation & Optimization</a></h4>
                                    <p class="mt-12">Our expert writers and designers create high-quality, SEO-friendly content that educates, engages, and converts.</p>
                                 </div>
                              </div>

                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    <h4><a href="#">Multi-Channel Distribution</a></h4>
                                    <p class="mt-12">We amplify your content across websites, blogs, social media, and email marketing to maximize reach and impact.</p>
                                 </div>
                              </div>

                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    <h4><a href="#">Performance Tracking & Continuous</a></h4>
                                    <p class="mt-12">We measure key metrics, analyze engagement, optimize content strategies for ongoing success.</p>
                                 </div>
                              </div>
                     ...
                     <article>
                        <div class="details-content mt-40">
                           <div class="heading2">
                              ...
                              <p class=" mt-16">we create powerful content marketing strategies designed to attract, engage, and convert your target audience. Our approach focuses on crafting high-quality, SEO-optimized content that not only boosts your brand’s visibility but also establishes your authority in the industry. From compelling blog articles and website copy to engaging social media posts and email campaigns, we develop content that resonates with and drives meaningful interactions.</p>
                           </div>

                           <div class="heading2 mt-40">
                              <h3>Captivating Content That Drives Results</h3>
                              <p class=" mt-16">By combining data-driven insights with creative storytelling, we ensure that your content delivers real results—more traffic, higher engagement, and increased conversions. Whether you're looking to educate your audience, nurture leads, or enhance brand loyalty, our expertly crafted content strategies will help you achieve your marketing goals.</p>
                           </div>
                           ...
                           <div class="service-details-check-list heading2 mt-30">
                              ...
                              <div class="text">
                                 <h4><a href="#">Data Driven Strategies</a></h4>
                                 <p class="mt-2">We create content based on insights, trends, and audience behavior.</p>
                              </div>
                           </div>
                           ...
                           <div class="service-details-check-list heading2 mt-30">
                              ...
                              <div class="text">
                                 <h4><a href="#">SEO-Focused Approach</a></h4>
                                 <p class="mt-2">Every piece of content is optimized to improve search rankings.</p>
                              </div>
                           </div>
                           ...
                           <div class="service-details-check-list heading2 mt-30">
                              ...
                              <div class="text">
                                 <h4><a href="#">Engaging & Shareable Content</a></h4>
                                 <p class="mt-2">We craft compelling narratives that resonate with your audience.</p>
                              </div>
                           </div>
                           ...
                           <div class="service-details-check-list heading2 mt-30">
                              ...
                              <div class="text">
                                 <h4><a href="#">Consistent & Scalable Solutions</a></h4>
                                 <p class="mt-2">From startups to enterprises, we deliver tailored content strategies.</p>
                              </div>
                           </div>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="image mt-40">
                                    <img class="w-full" src="assets/img/blog/blog-details-image2.png" alt="">
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="image mt-40">
                                    <img class="w-full" src="assets/img/blog/blog-details-image3.png" alt="">
                                 </div>
                              </div>
                           </div>
            ...
            <div class="row">
               <div class="col-lg-8 m-auto">
                  <div class="cta-header-area text-center sp4 white-heading">
                     ...
                     <p class="mt-16">Find the keywords your competitors rank for and analyze their <br class="d-lg-block d-none"> data insights to uncover their SEO strategy in one click</p>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-7 m-auto text-center">
                  <div class="heading2">
                     <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span3.svg" alt=""> WEBSITE ANALYSIS </span>
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="service-page-box mt-30">
                     ...
                     <div class="content-area">
                        ...
                        <a href="service-details1.php" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                        <h4><a href="service-details1.php">Business Strategy</a></h4>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-lg-6">
                  <div class="heading2">
                     <div class="contact2-form">
                        <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span3.svg" alt="">CONTACT US </span>

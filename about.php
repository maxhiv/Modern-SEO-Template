                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="heading2 ml-30 md:ml-0 sm:ml-0 md:mt-30 sm:mt-30">
                            ...
                            <p class="mt-16" data-aos="fade-left" data-aos-duration="700">Welcome to SEOX, where innovation meets expertise. We are a dynamic agency dedicated to empowering businesses across a variety of industries, offering tailored solutions that drive growth, efficiency, and success. With a proven
                                track record of delivering results, we bring passion, creativity, and cutting-edge strategies to every project we undertake.</p>
                            <p class="mt-16" data-aos="fade-left" data-aos-duration="700">We believe in turning visions into reality. As a versatile agency, we specialize in empowering businesses across diverse industries, including startups, HR staffing, social media marketing, solar energy, and real estate. Our
                                team is passionate about crafting innovative strategies that drive growth build strong brands.</p>
                            <div class="button mt-30" data-aos="fade-left" data-aos-duration="1000">
                                <a class="theme-btn3" href="contact.php">Contact Us <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="white-heading text-center">
                            <span class="sub-title"><img src="assets/img/icons/span1.svg" alt=""> SEOX INTERESTING FACTS</span>
                        </div>
                    </div>
                </div>
                <div class="row mt-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="image image-anime reveal md:mt-30 sm:mt-30">
                                        <img class="w-full" src="assets/img/about/about-choose-sec-image3.png" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="service1 sp sp sec-bg2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="heading2">
                            <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span3.svg" alt="">WHAT WE DO </span>
                            <h2 class="text-anime-style-3">Transforming Ideas into Impactful Results</h2>
                            <p class="mt-16">At SEOX, we specialize in crafting innovative and tailored solutions to empower businesses across a wide range of industries. From nurturing startups and streamlining HR staffing to boosting digital presence through social
                                media marketing and promoting sustainability with solar energy solutions, our expertise knows no bounds. </p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row mt-30">
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="200">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="service-details1.php">Startup Support</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="300">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="service-details1.php">HR Staffing Excellence</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="service-details1.php">Solar Energy Solutions:</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="300">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="service-details1.php">Real Estate Expertise</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="service-details1.php">Advertising & Branding</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="service-details1.php">E-Commerce Optimization</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="service-details1.php">travel Guide Expertise</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
                        <div class="about-service-box mt-30">
                            ...
                            <div class="heading2">
                                <h5><a href="service-details1.php">Insurance Policy</a></h5>
        ...
        <div class="tes11 sp">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 m-auto text-center">
                        <div class="heading2">
                            <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span3.svg" alt="">TESTIMONIALS </span>
                        ...
                        <div class="tes11-slider-all mt-30 _relative" data-aos="fade-up" data-aos-duration="900">
                            <div class="tes11-slider">
                                <div class="tes11-single-slider-items">
                                    <p>"Working with SEOX Advertising Agency has been a game-changer for our brand. The custom water bottles they designed were not only visually appealing but also high-quality and practical. We used them during our corporate
                                        events, and the response was phenomenal. Our clients loved the attention to detail, and many even commented on how these bottles reflected the premium nature of our brand. SEOX’s team made the entire process seamless,
                                        from brainstorming design ideas to ensuring timely delivery. We couldn’t have asked for a better partner in promoting our brand."</p>

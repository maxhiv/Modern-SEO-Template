...
<body class="body1">
   ...
   <?php include('partials/header-single/navbar10.php'); ?>
   ...
   <main>
            ...
            <div class="row">
               <div class="col-lg-6">
                  <div class="main-heading6">
                     ...
                     <h1 class="text-anime-style-3">Strata Recruitment for Lasting Impact</h1>
                     ...
                     <div class="buttons">
                        <a href="about.php" class="theme-btn11" bis_skin_checked="1">
      ...
      <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0">
         ...
         <div class="about6 sp" id="about">
            <div class="container">
               ...
               <div class="row mt-30 align-items-center">
                     ...
                     <div class="row about6-images mt-30">
                        <div class="col-lg-6">
                           <div class="image image-anime reveal">
                              <img src="assets/img/about/about6-image1.png" alt="">
                           </div>
                        </div>
                        <div class="col-lg-6">
                           <div class="image image-anime reveal">
                  ...
                  <div class="col-lg-6">
                     <div class="about6-content-box mt-50 ml-30 md:ml-0 sm:ml-0">
                        <div class="_relative">
                           <div class="icon">
                              <img src="assets/img/icons/about6-icon1.svg" alt="">
                           </div>
                           <div class="icon-shape">
                              <img src="assets/img/shapes/about6-icon-shape.svg" alt="">
                           </div>
                        </div>
                     ...
                     <div class="about6-content-box mt-50 ml-30 md:ml-0 sm:ml-0">
                        <div class="_relative">
                           <div class="icon">
                              <img src="assets/img/icons/about6-icon2.svg" alt="">
                           </div>
                           <div class="icon-shape">
                              <img src="assets/img/shapes/about6-icon-shape.svg" alt="">
                           </div>
                     ...
                     <div class="about6-content-box ml-30 mt-50 md:ml-0 sm:ml-0">
                        <div class="_relative">
                           <div class="icon">
                              <img src="assets/img/icons/about6-icon3.svg" alt="">
                           </div>
                           <div class="icon-shape">
                              <img src="assets/img/shapes/about6-icon-shape.svg" alt="">
                           </div>
                     ...
                     <div class="button ml-30 mt-50 md:ml-0 sm:ml-0">
                        <a href="about.php" class="theme-btn11" bis_skin_checked="1">
                           <span class="theme-btn11__shape"></span>
                           <span class="theme-btn11__shape"></span>
                           <span class="theme-btn11__shape"></span>
         ...
         <!--=== SERVICE AREA START === -->
         <div class="service6 sp sec-bg5" id="service">
            <div class="container">
               <div class="row align-items-center">
                  <div class="col-lg-6">
                     <div class="heading6 _mt-50">
                  ...
                  <div class="col-lg-6">
                     <div class="buttons text-end sm:text-start md:text-start sm:mt-20 md:mt-20">
                        <a href="service.php" class="theme-btn11" bis_skin_checked="1">
                           <span class="theme-btn11__shape"></span>
                           <span class="theme-btn11__shape"></span>
                           <span class="theme-btn11__shape"></span>
                           <span class="theme-btn11__shape"></span>
               ...
               <div class="row mt-30">
                     ...
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="service6-box mt-30">
                              ...
                              <div class="content heading6">
                                 <h4><a href="service-details1.php">Executive Search and Leadership Staffing</a></h4>
                        ...
                        <div class="col-lg-6">
                           <div class="service6-box mt-30">
                              ...
                              <div class="content heading6">
                                 <h4><a href="service-details1.php">HR Consulting and Workforce Planning</a></h4>
                        ...
                        <div class="col-lg-6">
                           <div class="service6-box mt-30">
                              ...
                              <div class="content heading6">
                                 <h4><a href="service-details1.php">Permanent Staffing Solutions</a></h4>
                  ...
                  <div class="col-md-6 col-lg-5">
                     <div class="service6-box mt-30">
                        ...
                        <div class="content heading6">
                           <h4><a href="service-details1.php">Candidate Screening and Background Checks</a></h4>
                     ...
                     <div class="service6-box mt-30">
                        ...
                        <div class="content heading6">
                           <h4><a href="service-details1.php">Payroll and Benefits Administration</a></h4>
               ...
               <div class="row mt-30">
                  <div class="col-lg-6">
                     <div class="image image-anime reveal mt-30">
                        <img src="assets/img/work/work6-image.png" alt="">
                     </div>
                  </div>
                  <div class="col-lg-6">
               ...
               <div class="row mt-30">
                  <div class="col-lg-4 col-md-6">
                     <div class="project6-box mt-30">
                        <div class="image">
                           <img class="w-full" src="assets/img/work/project6-image1.png" alt="">
                        </div>
                     ...
                     <div class="project6-box mt-30">
                        <div class="image">
                           <img class="w-full" src="assets/img/work/project6-image2.png" alt="">
                        </div>
                        <div class="content-box">
                           <h4><a href="#">Talent Connect Initiative</a></h4>
                           <p class="mt-10">we take pride in delivering tailored staffing solution that drive success for our clients projects showcase.</p>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="project6-box mt-30">
                        <div class="image">
                           <img class="w-full" src="assets/img/work/project6-image3.png" alt="">
                        </div>
                        <div class="content-box">
                           <h4><a href="#">Talent Connect Initiative</a></h4>
                           <p class="mt-10">we take pride in delivering tailored staffing solution that drive success for our clients projects showcase.</p>
                     ...
                     <div class="project6-box mt-30">
                        <div class="image">
                           <img class="w-full" src="assets/img/work/project6-image4.png" alt="">
                        </div>
                        <div class="content-box">
                           <h4><a href="#">Talent Connect Initiative</a></h4>
                           <p class="mt-10">we take pride in delivering tailored staffing solution that drive success for our clients projects showcase.</p>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="project6-box mt-30">
                        <div class="image">
                           <img class="w-full" src="assets/img/work/project6-image5.png" alt="">
                        </div>
                        <div class="content-box">
                           <h4><a href="#">Talent Connect Initiative</a></h4>
                           <p class="mt-10">we take pride in delivering tailored staffing solution that drive success for our clients projects showcase.</p>
                     ...
                     <div class="project6-box mt-30">
                        <div class="image">
                           <img class="w-full" src="assets/img/work/project6-image6.png" alt="">
                        </div>
                        <div class="content-box">
                           <h4><a href="#">Talent Connect Initiative</a></h4>
                           <p class="mt-10">we take pride in delivering tailored staffing solution that drive success for our clients projects showcase.</p>
         ...
         <div class="testimonial sp" id="tes">
            <div class="container">
               <div class="row">
               ...
               <div class="row mt-30 align-items-center">
                  <div class="col-lg-6">
                     <div class="tes6-image image-anime reveal mt-30">
                        <img class="w-full" src="assets/img/testimonial/tes6-image.png" alt="">
                     </div>
                  </div>
                  <div class="col-lg-6">
                        ...
                        <div class="tes6-slider-content">
                           <div class="tes6-slider">
                              <div class="tes6-single-slider">
                                 ...
                                 <div class="qoute">
                                    <img src="assets/img/icons/qoute6.svg" alt="">
                                 </div>
                                 ...
                                 <div class="bottom-area">
                                    ...
                                    <div class="google-logo">
                                       <img src="assets/img/others/google6.png" alt="">
                                    </div>
                                 </div>
                              </div>
               ...
               <div class="row align-items-center">
                  ...
                  <div class="col-lg-6">
                     <div class="faq6-images sm:mt-30 md:mt-30">
                        <div class="image1">
                           <img src="assets/img/others/faq6-image1.png" alt="">
                        </div>
                        <div class="image2">
                           <img src="assets/img/others/faq6-image2.png" alt="">
                        </div>
                        <div class="text-count">
                           <div class="shape-bg">
                              <img src="assets/img/shapes/faq6-text-shape.png" alt="">
                           </div>
                           <h3>18+</h3>
               ...
               <div class="row">
                  <div class="col-lg-6 m-auto text-center">
                     <div class="heading6 _mt-50">
                        ...
                        <h2>Maximizing Hiring Success Expert Advice</h2>
                     </div>
                  </div>
               </div>
               <div class="row mt-30">
                  <div class="col-lg-4 col-md-6">
                     <div class="vl-blog-6-item mt-30" data-aos="fade-up" data-aos-duration="900">
                        <div class="vl-blog-6-content heading6">
                           ...
                           <h4><a href="blog-details.php">Top Talent Acquisition Trends You Need to Know</a></h4>
                        </div>
                        <div class="thumb-area">
                           <div class=" vl-blog-6-thumb image-anime overflow-hidden _relative">
                              <img class="w-full" src="assets/img/blog/blog6-image1.png" alt="">
                           </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="vl-blog-6-item mt-30" data-aos="fade-up" data-aos-duration="900">
                        <div class="vl-blog-6-content heading6">
                           ...
                           <h4><a href="blog-details.php">Navigating the Challenges of Remote Workforce Staffing</a></h4>
                        </div>
                        <div class="thumb-area">
                           <div class=" vl-blog-6-thumb image-anime overflow-hidden _relative">
                              <img class="w-full" src="assets/img/blog/blog6-image2.png" alt="">
                           </div>
                           <div class="vl-blog6-btn">
                              <a href="blog-details.php" class="learn">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                           </div>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="vl-blog-6-item mt-30" data-aos="fade-up" data-aos-duration="900">
                        <div class="vl-blog-6-content heading6">
                           ...
                           <h4><a href="blog-details.php">The Importance of Diversity and Inclusion in Hiring</a></h4>
                        </div>
                        <div class="thumb-area">
                           <div class=" vl-blog-6-thumb image-anime overflow-hidden _relative">
                              <img class="w-full" src="assets/img/blog/blog6-image3.png" alt="">
                           </div>
                           <div class="vl-blog6-btn">
                              <a href="blog-details.php" class="learn">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                           </div>

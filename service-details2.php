               ...
               <div class="col-lg-12">
                  <article>
                     <div class="details-content">
                        <div class="image">
                           <img class="w-full" src="assets/img/service/service-details2-image.png" alt="">
                        </div>
                     </div>
                  </article>
               </div>
                     ...
                     <div class="_sidebar-widget _list mt-40">
                        ...
                        <div class="sidebar-list">
                           <ul>
                              ...
                              <li><a href="service-details2.php" class="active">Social Media Strategy <span><i class="fa-solid fa-angle-right"></i></span></a></li>

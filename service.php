            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="assets/img/service/service5-image5.png" alt="">
                            </div>
                            <div class="content-area">
                                <div class="num">05</div>
                                <a href="service-details1.php" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="service-details1.php">HR Staffing</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="assets/img/service/service5-image6.png" alt="">
                            </div>
                            <div class="content-area">
                                <div class="num">06</div>
                                <a href="service-details1.php" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="service-details1.php">Web Design</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="assets/img/service/service5-image7.png" alt="">
                            </div>
                            <div class="content-area">
                                <div class="num">07</div>
                                <a href="service-details1.php" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="service-details1.php">Real Estate</a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="assets/img/service/service5-image8.png" alt="">
                            </div>
                            <div class="content-area">
                                <div class="num">08</div>
                                <a href="service-details1.php" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="service-details1.php">Advertising </a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="assets/img/service/service5-image9.png" alt="">
                            </div>
                            <div class="content-area">
                                <div class="num">09</div>
                                <a href="service-details1.php" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="service-details1.php">E-commerce </a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="assets/img/service/service5-image10.png" alt="">
                            </div>
                            <div class="content-area">
                                <div class="num">10</div>
                                <a href="service-details1.php" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="service-details1.php">Travel Guide </a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="assets/img/service/service5-image11.png" alt="">
                            </div>
                            <div class="content-area">
                                <div class="num">11</div>
                                <a href="service-details1.php" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="service-details1.php">Insurance </a></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-page-box mt-30">
                            <div class="image">
                                <img src="assets/img/service/service5-image12.png" alt="">
                            </div>
                            <div class="content-area">
                                <div class="num">12</div>
                                <a href="service-details1.php" class="arrow"><i class="fa-regular fa-arrow-right"></i></a>
                                <h4><a href="service-details1.php">Solar Energy </a></h4>
                            </div>
                        </div>
                    </div>

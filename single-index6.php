...
<body class="body1">
   ...
   <?php include('partials/header-single/navbar6.php'); ?>

   <main>
      <!--==== HERO AREA START =====-->
      <div class="hero9 _relative" style="background-image: url(assets/img/bg/hero9-bg.png);">
         <div class="container">
            <div class="row">
               <div class="col-lg-6">
                  <div class="main-heading9">
                     <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span9.svg" alt="">Expert Social Media Strategies </span>
      ...
      <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0">
         ...
         <div class="about9 sp" id="about">
            <div class="container">
               <div class="row">
                  <div class="col-lg-6">
                     <div class="about9-images">
                        <div class="shape1 overflow-hidden _relative reveal">
                           <img src="assets/img/shapes/about9-shape1.png" alt="">
                        </div>
                        <div class="shape2">
                           <img src="assets/img/shapes/about9-shape2.png" alt="">
                        </div>
                        <div class="shape3">
                           <img src="assets/img/shapes/about9-shape3.png" alt="">
                        </div>
                        <div class="shape4">
                           <div class="num">
                              <h3>10+</h3>
                  ...
                  <div class="col-lg-6">
                     <div class="heading9">
                        <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span9.svg" alt=""> Crafting Custom Strategies</span>
                           ...
                           <div class="row">
                              <div class="col-md-3 col-6">
                                 <div class="count-box">
                                    <h3>24</h3>
                                    <p>Countries</p>
                                    <img src="assets/img/shapes/about9-count-shape.png" alt="" class="count-shape">
                                 </div>
                              </div>
         ...
         <!--==== SERVICE AREA START =====-->
         <div class="service9 sp bg-cover" id="service" style="background-image: url(assets/img/bg/sec-bg9.jpg);">
            <div class="container">
               <div class="row">
                  <div class="col-lg-6 m-auto text-center">
                     <div class="heading9">
                        <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span9.svg" alt=""> Full-Service Social Media</span>
               ...
               <div class="row mt-30">
                  <div class="col-md-6 col-lg-4" data-aos="zoom-in-up" data-aos-duration="800">
                     <div class="service9-box mt-90">
                        <div class="icon">
                           <img src="assets/img/icons/service9-icon1.png" alt="">
                        </div>
                        <div class="content heading9">
                           <h4><a href="service-details1.php">Social Media Strategy</a></h4>
                           ...
                           <a href="service-details1.php" class="theme-btn18 mt-24">
                  ...
                  <div class="col-md-6 col-lg-4" data-aos="zoom-in-up" data-aos-duration="900">
                     <div class="service9-box mt-90">
                        <div class="icon">
                           <img src="assets/img/icons/service9-icon2.png" alt="">
                        </div>
                        <div class="content heading9">
                           <h4><a href="service-details1.php">Social Media Advertising</a></h4>
                  ...
                  <div class="col-md-6 col-lg-4" data-aos="zoom-in-up" data-aos-duration="1000">
                     <div class="service9-box mt-90">
                        <div class="icon">
                           <img src="assets/img/icons/service9-icon3.png" alt="">
                        </div>
                        <div class="content heading9">
                           <h4><a href="service-details1.php">Social Media Analytics</a></h4>
                  ...
                  <div class="col-md-12 col-lg-5" data-aos="zoom-in-up" data-aos-duration="1100">
                     <div class="service9-box mt-90">
                        <div class="icon">
                           <img src="assets/img/icons/service9-icon4.png" alt="">
                        </div>
                        <div class="content heading9">
                           <h4><a href="service-details1.php">Influencer Marketing Partnerships</a></h4>
                     ...
                     <div class="service9-box mt-90 add_thumb _relative">
                        <div class="row">
                           <div class="col-lg-6">
                              <div class="_relative">
                                 <div class="icon">
                                    <img src="assets/img/icons/service9-icon5.png" alt="">
                                 </div>
                                 <div class="content heading9">
                                    <h4><a href="service-details1.php">Video And Reels Marketing</a></h4>
                           ...
                           <div class="col-lg-6">
                              <div class="service-box-thum _relative">
                                 <img src="assets/img/service/service9-thum.png" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="row align-items-center">
                  <div class="col-lg-6">
                     <div class="heading9 mr-60 md:mr-0 sm:mr-0">
                        <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span9.svg" alt=""> Social Media Growth Progress</span>
                        ...
                        <div class="button mt-20" data-aos="fade-right" data-aos-duration="1200">
                           <a href="service-details1.php" class="theme-btn17 mt-24">
                              <span class="theme-btn17__shape"></span>
                              <span class="theme-btn17__shape"></span>
                              <span class="theme-btn17__shape"></span>
                              <span class="theme-btn17__shape"></span>
                  ...
                  <div class="col-lg-6">
                     <div class="progress9-image reveal overflow-hidden _relative">
                        <img src="assets/img/others/progress9-image.png" alt="">
                     </div>
                  </div>
               </div>
            </div>
         ...
         <!--==== TEAM AREA START =====-->
         <div class="team9 sp bg-cover" id="team" style="background-image: url(assets/img/bg/sec-bg9.jpg);">
            <div class="container">
               <div class="row">
                  <div class="col-lg-6 m-auto text-center">
                     <div class="heading9">
                        <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span9.svg" alt=""> our creative team</span>
               ...
               <div class="row mt-30">
                  <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200">
                     <div class="team9-box mt-30">
                        <div class="team-thumbnail-area">
                           <div class="image">
                              <img src="assets/img/team/team9-image1.png" alt="">
                           </div>
                           <div class="shape">
                              <img src="assets/img/shapes/team9-shape.png" alt="">
                           </div>
                        </div>
                  ...
                  <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1000">
                     <div class="team9-box mt-30">
                        <div class="team-thumbnail-area">
                           <div class="image">
                              <img src="assets/img/team/team9-image2.png" alt="">
                           </div>
                           <div class="shape">
                              <img src="assets/img/shapes/team9-shape.png" alt="">
                           </div>
                  ...
                  <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="800">
                     <div class="team9-box mt-30">
                        <div class="team-thumbnail-area">
                           <div class="image">
                              <img src="assets/img/team/team9-image3.png" alt="">
                           </div>
                           <div class="shape">
                              <img src="assets/img/shapes/team9-shape.png" alt="">
                           </div>
         ...
         <div class="tes9 sp" id="tes">
            <div class="container">
               <div class="row">
                  <div class="col-lg-6 m-auto text-center">
                     <div class="heading9">
                        <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span9.svg" alt=""> Our Happy Clients</span>
               ...
               <div class="row mt-30 align-items-center">
                  <div class="col-lg-5">
                     <div class="tes9-images mt-30" data-aos="zoom-in-left" data-aos-duration="900">
                        <div class="image">
                           <img src="assets/img/testimonial/tes9-image.png" alt="">
                        </div>
                        <div class="image-shape round-circle">
                           <img src="assets/img/shapes/tes9-image-shape.png" alt="">
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
                        ...
                        <div class="tes9-slider">
                           <div class="tes9-single-slider">
                              ...
                              <div class="content mt-20">
                                 <p>“We’ve been working with SEOX for over a year now, and the best results have been outstanding! Their team took the time to the on understand our business and crafted a tailored strategy that best dramatically
                                    improved our search rankings and web traffic.”</p>
                              </div>
         ...
         <!--=== BLOG AREA START === -->
         <div class="blog9 sp bg-cover" id="blog" style="background-image: url(assets/img/bg/sec-bg9.jpg);">
            <div class="container">
               <div class="row">
                  <div class="col-lg-6 m-auto text-center">
                     <div class="heading9">
                        <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span9.svg" alt=""> Insights from Our Experts</span>
                        ...
                        <div class="row align-items-center">
                           <div class="col-lg-6">
                              <div class="vl-blog-9-thumb image-anime overflow-hidden _relative">
                                 <img class="w-full" src="assets/img/blog/blog9-image.png" alt="">
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class="vl-blog-9-content heading9">
                                 ...
                                 <h4><a href="blog-details.php">Facebook vs. Instagram Ads: Which Platform Is Right for Your Business?</a></h4>
                                 ...
                                 <a href="blog-details.php" class="theme-btn18 mt-24">
                                    <span class="theme-btn18__shape"></span>
                                    <span class="theme-btn18__shape"></span>
                                    <span class="theme-btn18__shape"></span>
                                    <span class="theme-btn18__shape"></span>
                  ...
                  <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="800">
                     <div class="vl-blog-9-item mt-40 hover-effect">
                        <div class="vl-blog-9-content heading9">
                           ...
                           <h5><a href="blog-details.php">How to Use Video Content Drive Engagementing on Social Media</a></h5>
                  ...
                  <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1000">
                     <div class="vl-blog-9-item mt-40 hover-effect">
                        <div class="vl-blog-9-content heading9">
                           ...
                           <h5><a href="blog-details.php">Why Social Media Marketing Is Essential Your Business Growth</a></h5>
                  ...
                  <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200">
                     <div class="vl-blog-9-item mt-40 hover-effect">
                        <div class="vl-blog-9-content heading9">
                           ...
                           <h5><a href="blog-details.php">How to Use Video Content Drive Engagement The Social Media</a></h5>
      ...
      <!--==== CTA AREA START =====-->
      <div class="cta9" style="background-image: url(assets/img/bg/cta9-bg.png);">
         <div class="container">
            <div class="row">
               <div class="col-lg-5">
               ...
               <div class="col-lg-7">
                  <div class="cta9-apps-image ml-60 sm:ml-0 md:ml-0 sm:mt-30 md:mt-30">
                     <img src="assets/img/apps/cta9-apps.png" alt="">
                  </div>
               </div>
            </div>
         </div>

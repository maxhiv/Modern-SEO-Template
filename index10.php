...
<body class="body1">
    ...
    <?php include('partials/header/navbar10.php'); ?>
                            ...
                            <div class="tes6-slider-content">
                                <div class="tes6-slider">
                                    <div class="tes6-single-slider">
                                        ...
                                        <p class="content-text">“At Seo, we measure our success by the satisfaction of our clients and candidates. Every placement we make is a testament to our dedication, expertise, & commitment to excellence From helping businesses find the
                                            right.”</p>

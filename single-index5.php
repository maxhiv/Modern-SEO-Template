...
<body class="body1">
    ...
    <?php include('partials/header-single/navbar5.php'); ?>
    ...
    <main>
        ...
        <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0">
                        ...
                        <div class="col-lg-6">
                            <div class="heading4 ml-40 sm:ml-0 md:ml-0">
                                ...
                                <div class="about4-service-list" data-aos="fade-left" data-aos-duration="1000">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="list">
                                                <ul>
                                                    <li><span class="check"><i class="fa-solid fa-check"></i></span> Digital Marketing</li>
                                                    <li><span class="check"><i class="fa-solid fa-check"></i></span> Marketing Agency</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="list">
                                                <ul>
                                                    <li><span class="check"><i class="fa-solid fa-check"></i></span> SEO Optimization</li>
                                                    <li><span class="check"><i class="fa-solid fa-check"></i></span> First Working Process</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="button mt-30" data-aos="fade-left" data-aos-duration="1100">
                                    <a href="about.php" class="theme-btn8">
                                        <span class="theme-btn8__shape"></span>
                                        <span class="theme-btn8__shape"></span>
                                        <span class="theme-btn8__shape"></span>
                                        <span class="theme-btn8__shape"></span>
            ...
            <!--=== SERVICE AREA START === -->
            <div class="service4 sp sec-bg3" id="service">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="heading4">
                        ...
                        <div class="col-lg-6">
                            <div class="text-end button md:mt-20 sm:mt-20 md:text-start sm:text-start">
                                <a href="service.php" class="theme-btn8">
                                    <span class="theme-btn8__shape"></span>
                                    <span class="theme-btn8__shape"></span>
                                    <span class="theme-btn8__shape"></span>
                                    <span class="theme-btn8__shape"></span>
                    ...
                    <div class="row mt-30">
                        <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="200">
                            <div class="service4-box mt-30">
                                ...
                                <div class="heading4 mt-20">
                                    <h4><a href="service-details1.php">Search Engine Optimization (SEO)</a></h4>
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="300">
                            <div class="service4-box mt-30">
                                ...
                                <div class="heading4 mt-20">
                                    <h4><a href="service-details1.php">Pay-Per-Click Advertising (PPC)</a></h4>
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="400">
                            <div class="service4-box mt-30">
                                ...
                                <div class="heading4 mt-20">
                                    <h4><a href="service-details1.php">Content Marketing</a></h4>
                        ...
                        <div class="col-lg-6 col-md-6" data-aos="zoom-in-up" data-aos-duration="800" data-aos-delay="200">
                            <div class="service4-box mt-30">
                                ...
                                <div class="heading4 mt-20">
                                    <h4><a href="service-details1.php">Social Media Marketing (SMM)</a></h4>
                        ...
                        <div class="col-lg-6 col-md-6" data-aos="zoom-in-up" data-aos-duration="1000" data-aos-delay="300">
                            <div class="service4-box mt-30">
                                ...
                                <div class="heading4 mt-20">
                                    <h4><a href="service-details1.php">Web Design & Development</a></h4>
            ...
            <div class="case4 sp sec-bg3">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="heading4">
                                <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span1.svg" alt=""> CASE STUDY</span>
            ...
            <!--=== BLOG AREA START === -->
            <div class="blog4 sp sec-bg3" id="blog">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="heading4">
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1100">
                            <div class="vl-blog-4-item add-bg mt-30">
                                ...
                                <div class="vl-blog-4-content heading4 mt-30">
                                    ...
                                    <h5><a href="blog-details.php">Mastering Digital Marketing: Actionable Insights to Drive Real Results for Your Business</a></h5>
                                    <a href="blog-details.php" class="learn1">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="800">
                            <div class="vl-blog-4-item  add-bg mt-30">
                                ...
                                <div class="vl-blog-4-content heading4 mt-30">
                                    ...
                                    <h5><a href="blog-details.php">The Future of Digital Marketing Trends Technologies Shaping Tomorrow’s Strategies</a></h5>
                                    <a href="blog-details.php" class="learn1">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1000">
                            <div class="vl-blog-4-item add-bg mt-30">
                                ...
                                <div class="vl-blog-4-content heading4 mt-30">
                                    ...
                                    <h5><a href="blog-details.php">From SEO to Social Media: Proven Techniques to Build Your Brand Online</a></h5>
                                    <a href="blog-details.php" class="learn1">Read More <span class="arrow1"><i class="fa-solid fa-arrow-right"></i></span><span class="arrow2"><i class="fa-solid fa-arrow-right"></i></span></a>
                                </div>
                            </div>
                        </div>
            ...
            <!--=== CONTACT AREA START === -->
            <div class="contact4 sp" is="contact">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="contact4-form-area">
                                <div class="heading4">
                                    <span class="sub-title" data-aos="zoom-in-left" data-aos-duration="900"><img src="assets/img/icons/span1.svg" alt=""> CONTACT US</span>
    ...
    <footer class="vl-footer-area4 bg-cover" style="background-image: url(assets/img/bg/footer4-bg.jpg);">
        <!-- footer area start -->

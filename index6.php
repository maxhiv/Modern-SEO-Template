...
<body class="body">
    ...
    <?php include('partials/header/navbar6.php'); ?>
    ...
    <main>
        ...
        <!--==== SERVICE AREA START =====-->
        <div class="service9 sp bg-cover" style="background-image: url(assets/img/bg/sec-bg9.jpg);">
            <div class="container">
                <div class="row">
        ...
        <!--==== TEAM AREA START =====-->
        <div class="team9 sp bg-cover" style="background-image: url(assets/img/bg/sec-bg9.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 m-auto text-center">
                        <div class="heading9">
        ...
        <!--=== BLOG AREA START === -->
        <div class="blog9 sp bg-cover" style="background-image: url(assets/img/bg/sec-bg9.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 m-auto text-center">
                        <div class="heading9">
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="800">
                        <div class="vl-blog-9-item mt-40 hover-effect">
                            <div class="vl-blog-9-content heading9">
                                ...
                                <h5><a href="blog-details.php">How to Use Video Content Drive Engagementing on Social Marketing</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200">
                        <div class="vl-blog-9-item mt-40 hover-effect">
                            <div class="vl-blog-9-content heading9">
                                ...
                                <h5><a href="blog-details.php">How to Use Video Content Drive Engagement The Social Marketing</a></h5>

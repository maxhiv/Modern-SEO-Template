               ...
               <div class="col-lg-12">
                  <article>
                     <div class="details-content">
                        <div class="image">
                           <img class="w-full" src="assets/img/service/service-details8-image.png" alt="">
                        </div>
                     </div>
                  </article>
               </div>
                     ...
                     <div class="_sidebar-widget _list mt-40">
                        ...
                        <div class="sidebar-list">
                           <ul>
                              ...
                              <li><a href="service-details8.php" class="active">Real Estate <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                     ...
                     <article>
                        <div class="details-content">
                           <div class="heading2 mt-24">
                              ...
                              <p class=" mt-16">We provide expert real estate services to help you find your dream home, secure profitable investments, and navigate the property market with ease. Whether you're buying, selling, or investing, our team offers tailored solutions to match your needs. With a deep understanding of market trends, premium property listings, and expert negotiation skills, we ensure a seamless real estate experience.</p>
                           </div>
                           ...
                           <div class="row pt-10">
                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    <h4><a href="#">Residential Property Sales Purchases</a></h4>
                                    <p class="mt-12">Find your perfect home or sell your property at the best value.</p>
                                 </div>
                              </div>

                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    <h4><a href="#">Commercial Real Estate Solutions </a></h4>
                                    <p class="mt-12">Secure prime office spaces, retail locations, and business properties.</p>
                                 </div>
                              </div>

                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    <h4><a href="#">Real Estate Investment Consulting</a></h4>
                                    <p class="mt-12">Get expert advice on market trends, ROI, and profitable opportunities.</p>
                                 </div>
                              </div>

                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    <h4><a href="#">Rental & Leasing Services</a></h4>
                                    <p class="mt-12">Hassle-free solutions for landlords and tenants.</p>
                                 </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    ...
                                    <p class="mt-12">Professional services to maintain and maximize the value of your real estate.</p>
                                 </div>
                              </div>

                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    <h4><a href="#">Legal & Financial Assistance</a></h4>
                                    <p class="mt-12">Guidance on mortgages, property laws, and transaction processes.</p>
                                 </div>
                              </div>

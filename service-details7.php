               ...
               <div class="col-lg-12">
                  <article>
                     <div class="details-content">
                        <div class="image">
                           <img class="w-full" src="assets/img/service/service-details7-image.png" alt="">
                        </div>
                     </div>
                  </article>
               </div>
                     ...
                     <div class="_sidebar-widget _list mt-40">
                        ...
                        <div class="sidebar-list">
                           <ul>
                              ...
                              <li><a href="service-details3.php">Content Marketing <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                              ...
                              <li><a href="service-details7.php" class="active">Insurance Policy <span><i class="fa-solid fa-angle-right"></i></span></a></li>
                     ...
                     <article>
                        <div class="details-content">
                           <div class="heading2 mt-24">
                              ...
                              <p class=" mt-16">We offer a wide range of insurance policies designed to protect you, your family, and your assets. Whether you're looking for health insurance, life coverage, auto protection, or business policies, our expert team helps you choose the right plan tailored to your needs. With flexible options and trusted providers, we ensure that you receive the best coverage at competitive rates, giving you the security and peace of mind you deserve.</p>
                           </div>
                           ...
                           <div class="row pt-10">
                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    ...
                                    <p class="mt-12">Comprehensive plans covering medical expenses, hospital stays, preventive care.</p>
                                 </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    ...
                                    <p class="mt-12">Secure your family's future with term, whole, or universal life policies.</p>
                                 </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    ...
                                    <p class="mt-12">Protection for your vehicle against accidents, theft, and damage.</p>
                                 </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    ...
                                    <p class="mt-12">Safeguard your property from unforeseen damages and liabilities.</p>
                                 </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    ...
                                    <p class="mt-12">Custom policies to protect your company from financial risks and legal liabilities.</p>
                                 </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                 <div class="details-content-text-box heading2 mt-30">
                                    ...
                                    <p class="mt-12">Coverage unexpected travel emergencie medical expenses, and trip cancellations.</p>
                                 </div>
                              </div>
                     ...
                     <article>
                        <div class="details-content mt-40">
                           <div class="heading2">
                              ...
                              <p class=" mt-16">Our insurance professionals help you navigate complex policy details with ease. Choose from a variety of customizable plans for individuals and businesses. Get the best coverage at affordable rates from top providers. Our team ensures smooth and quick claims assistance when you need it most. We’re always here to answer your insurance-related questions and concerns. </p>
                           </div>

                           <div class="heading2 mt-40">
                              <h3>Get the Right Insurance Policy Today!</h3>
                              <p class=" mt-16">At SEOX, we make insurance planning simple and stress-free. Whether you need coverage for yourself, your family, or your business, we help you find the perfect policy for your needs.</p>
                           </div>
                           ...
                           <div class="service-details-check-list heading2 mt-30">
                              ...
                              <div class="text">
                                 <h4><a href="#">Understanding Your Coverage Needs</a></h4>
                                 <p class="mt-2">We assess your lifestyle, financial goals, and risk factors to recommend the best insurance plan.</p>
                              </div>
                           </div>
                           ...
                           <div class="service-details-check-list heading2 mt-30">
                              ...
                              <div class="text">
                                 <h4><a href="#">Customizing Your Plan</a></h4>
                           ...
                           <div class="service-details-check-list heading2 mt-30">
                              ...
                              <div class="text">
                                 <h4><a href="#">Ongoing Support & Assistance</a></h4>
                                 <p class="mt-2">We provide continuous policy reviews and expert assistance for claims, renewals, and updates.</p>
                              </div>
                           </div>
                           ...
                           <div class="service-details-check-list heading2 mt-30">
                              ...
                              <div class="text">
                                 <h4><a href="#">Exploring Policy Options</a></h4>
                                 <p class="mt-2">We present multiple policy options from trusted providers to help you make an informed decision.</p>
                              </div>
                           </div>
